...
class LunarLander(gym.Env, EzPickle):
    ...
    * The angular velocity is in units of 0.4 radians per second. In order to convert to radians per second, the value needs to be multiplied by a factor of 2.5.
    ...
    def __init__(
        ...
        assert(main_engine_power > 0 and side_engine_power > 0), f"engine powers should be positive!" 
        self.main_engine_power = main_engine_power # added to self and change all MAIN_ENGINE_POWER to self.main_engine_power
        self.side_engine_power = side_engine_power # same for side
